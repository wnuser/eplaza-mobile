...
import 'package:e_plaza/widgets/image_view.dart';
    ...
    try {
          ...
          errorWidget: (context, string, dynamic) {
            ...
            return errorWidget ??
                Container(
                  ...
                  child:  Center(
                    child: Image.asset('assets/images/noImageplaceholder.png'), // Replace with your default image asset
                  ),
                );
          },
      ...
      return errorWidget ??
          Container(
            color: errorBackgroundColor ?? Colors.red.shade50,
            child:  Center(
                child: Image.asset('assets/images/noImageplaceholder.png',width: 50,height: 50,), // Replace with your default image asset
            ),
          );
    }
  }
