...
class ImageViewScreen extends StatefulWidget {
  ...
  ImageViewScreen(this._basePath, this._imageName,
      {Key? key, this.title, this.images = const []})
      : super(key: key);
        ...
        child: Stack(
          children: [
            PageView.builder(
              ...
              itemBuilder: (ctx, pos) {
                widget._imageName =
                    images.isNotEmpty ? images[pos] : widget._imageName;
                return PhotoView(
                  backgroundDecoration:
                      const BoxDecoration(color: Colors.white),
                  imageProvider: NetworkImage(
                      widget._basePath + widget._imageName.nullSafe),
