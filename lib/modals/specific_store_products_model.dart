class SpecificStoreProducts {
  List<Data>? data;
  bool? success;

  SpecificStoreProducts({this.data, this.success});
  
  SpecificStoreProducts.fromJson(Map<String, dynamic> json) {
    print('init from jsonnnnnnnnnnnnnnn');
    if (json['data'] != null) {
      data = <Data>[];
      json['data'].forEach((v) {
