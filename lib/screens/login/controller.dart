...
class Controller extends GetxController {
  ...
  void login(String username, String password) {
    ...
    //   Toasty.failed(Strings.get('pleaseEnterEmailId'));
    //   return;
    // }
    //
    // if (!username.isEmail) {
    //   Toasty.failed(Strings.get('pleaseEnterValidEmailId'));
    //   return;
    // }
    //
    // if (Helper.isEmpty(password)) {
    //   Toasty.failed(Strings.get('pleaseEnterPassword'));
    //   return;
    // }
    //
    // status.value = Status.PROGRESS;
    //
    // Repository.instance.login(username, password).then(loginSuccess);
  }
