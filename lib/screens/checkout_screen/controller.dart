...
class Controller extends GetxController {
  ...
  TextEditingController roadNameAreaColonyController = TextEditingController();
  ...
  final List<StoreProduct> storeProductsMain = <StoreProduct>[];
  final RxList<StoreProduct> storeProducts = <StoreProduct>[
