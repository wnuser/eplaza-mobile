...
class _AddProductScreenState extends State<AddProductScreen> {
                ...
                children: [
                  Align(
                    ...
                    child: SizedBox(
                        ...
                        child: Obx(
                          () => _controller.images.isNotEmpty && _controller.imageErrors.isNotEmpty
                              ? Center(
                      ...
                      Expanded(
                        child: NormalTextField(
                          ...
                          validator: (s) {
                            ...
                            if (_controller.offerPriceController.text.toInt <
                                _controller.discountPriceController.text.toInt) {
                              return 'Discounted price cannot be grater MRP!';
                            }
                            return null;
                          },
                          border: NormalTextField.outlinedBorder,
                      ...
                      child: Obx(
                        () => Text(
                          _controller.calculatedPercentage.value < 0 ||
                              ...
                              ? 'Invalid Price'
                              : _controller.calculatedPercentage.value.toStringAsFixed(1) + '% OFF',
                          style: MyTextStyle(
                            color: Colors.white,
                  ...
                  Obx(
                    () => _controller.categories.value != null
                        ? NormalTextField<Category>.dropdownWithSearch(
                            label: 'Category',
                            ...
                            onSelected: (c) {
                              ...
                              _controller.getSubCategories(c.id.nullSafe);
                              _controller.selectedSubCategoryId = '';
                              _controller.subCategoryController.clear();
                  ...
                  Helper.spaceVertical(12),
                  Obx(
                    () => _controller.subCategories.value != null
                        ? NormalTextField<sub.SubCategory>.dropdownWithSearch(
                            label: 'Sub Category',
                            controller: _controller.subCategoryController,
                            dropdownList: _controller.subCategories,
                            onSelected: (c) {
                              _controller.selectedSubCategoryId = (c.id ?? 0).toString();
                              return c.name.nullStr;
                            },
                            contentPadding: EdgeInsets.symmetric(horizontal: 4, vertical: 8),
                            validator: Helper.emptyValidator,
                  ...
                  Obx(
                    () => _controller.return_.value
                        ? Padding(
                            ...
                            child: Text('Refund will be in 7 days according to Eplaza standard'),
                          )
                        : empty(),
                  ),
          ...
          Obx(
            () => _controller.status.value == Status.PROGRESS
                ...
                : PrimaryButton(
                    ...
                    height: 6.h,
                    borderRadius: 6,
                    textStyle: MyTextStyle(color: ThemeColors.white, fontWeight: FontWeight.w500),
                    onPressed: () {
                      if (widget.action == 'ADD') {
                        _controller.addProduct(widget.action);
                      }
                    },
                  ),
          ),
  ...
  Widget _pickFileWidget(c, i) {
    ...
    return Obx(
      () {
        if (_controller.imageErrors.value != null) {
          return Container(
            width: imgSize,
            height: imgSize,
