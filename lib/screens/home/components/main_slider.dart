...
import 'package:e_plaza/apiHandler/network_constant.dart';
...
class MainSlider extends StatelessWidget {
  ...
  final List<HomeSliderMainModel> slides;
  ...
  List<Widget> get _slides => slides.map((item) {
    ...
    return CarouselSlider.builder(
      ...
      itemBuilder: (context, index, realIndex) {
        final bannerImage = data![index].bannerImage!;
        print("mainbannerpath"+bannerImage);
        return Container(
          decoration: BoxDecoration(
