...
import 'package:e_plaza/screens/home/components/random_products/random_product_mini_item.dart';
import 'package:flutter/material.dart';

import '../../../../modals/LatestProduct.dart';
import '../../../../modals/product.dart';

class RandomProductItemGroup extends StatelessWidget {
  final List<RandomProductsModel> products;

  RandomProductItemGroup(this.products, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GridView(
        ...
        children: products.map((e) => RandomProductMiniItem(e)).toList(),
      ),
    );
  }
}
