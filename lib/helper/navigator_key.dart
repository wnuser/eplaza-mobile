...
class LocalizationString {
  ...
  static String welcome_otp = 'Verify OTP'.tr;
  static String welcome_social = 'Social Profile'.tr;
  static String welcome_reffral = 'Referral Code'.tr;
  ...
  static String refferanderan = 'Reffer and Earn'.tr;
  ...
  static String signInMessage = 'We welcome you to kittyclub family'.tr;
  static String loginOTPMessage = 'Please enter OTP to verify you identity.'.tr;
  static String loginSocailMessage = 'Please share your social profile with us.'.tr;
  static String loginRefferalMessage = 'Please enter referral code to continue.'.tr;
  ...
  static String enterMobile = 'Please enter your mobile no'.tr;
  static String enterRefferalCode = 'Please enter referral code'.tr;
  ...
  static String pleaseEnterZipcode = 'Please enter zipcode'.tr;
  ...
  static String pleaseEnterfName = 'Please enter first name'.tr;
  static String pleaseEnterlName = 'Please enter last name'.tr;
  ...
  static String connectionEarning = 'Total connection earning'.tr;
  static String gameWiningEarning = 'Total game winning earning'.tr;
  static String gameCreateEarning = 'Total game create earning'.tr;
  ...
  static String pleaseEnterValidMobile = 'Please enter valid mobile'.tr;
  static String pleaseEnterValidOTP = 'Please enter valid otp'.tr;

  static String pleaseEnterValidReffralCode = 'Please enter valid refferal code'.tr;
  ...
  static String pleaseEnterValidGameName = 'Please enter valid game name'.tr;
  static String pleaseEnterValidGameDate = 'Please enter valid game date'.tr;
  static String pleaseEnterValidGameTime = 'Please enter valid game time'.tr;
  static String pleaseEnterValidGamePrice = 'Please enter valid game price'.tr;

  static String pleaseEnterValidGameID = 'Please enter valid game ID'.tr;
  ...
  static String games_list = "Games".tr;
  static String invite_user = "Invite Users".tr;
  ...
  static String gameMembers = "Game Members".tr;
  static String clubSettings = 'Club Settings'.tr;


  //games club view
  static String all_games = 'All'.tr;
  static String joined_games = 'Joined'.tr;
  static String my_games = "My Games".tr;
  static String game_invite = "Invites".tr;
  static String game_leaderboard = "Leaderboard".tr;
  static String game_free = "Free Games".tr;



  //games invite view
  static String game_follower_list = 'Followers'.tr;
  static String game_following_list = 'Following'.tr;
  ...
  static String joinGame = 'Join games to earn money'.tr;
  ...
  static String watchTv = 'Live TV'.tr;
  ...
  static String playnow = 'Play Now'.tr;
