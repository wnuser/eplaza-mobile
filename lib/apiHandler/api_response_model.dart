...
class ApiResponseModel {
  ...
  // int createdPostId = 0;
  //
  // List<MyTicketTambolaGameModel> myTambolaTicket = [];
  ...
  // List<CreateGameModel> createGameModellist = [];
  //
  ...
  //
  // List<GamesClubsCategoriesModel> games_categories = [];
  //
  //
  ...
  //         Get.to(() => const LoginMobileViewScreen());
  //       });
  //     } else if (data['token'] != null) {
  //       model.token = data['token'] as String;
